...
namespace Sm\ShoppyStore\Model\Import;
...
class Cms
{
    ...
    public function __construct(
        ...
        $this->_importPath = BP . '/app/code/Sm/ShoppyStore/etc/import/';
    ...
    public function importCms($type)
    {
        ...
        try {
            ...
            if($this->_scopeConfig->getValue("shoppystore/theme_install/overwrite_".$type)) {
                $overwrite = true;
            }
